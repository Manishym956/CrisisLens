  ...
  return (
    <div className="max-w-7xl mx-auto px-margin py-xl space-y-lg">
      <header className="flex justify-between items-end mb-lg">
        <div>
          <h1 className="font-h1 text-h1 text-primary glow-cyan mb-xs">Command Center</h1>
          <p className="text-on-surface-variant font-body-lg text-body-lg">Global misinformation live tracking & threat analysis.</p>
        </div>
        <div className="flex items-center gap-xs text-label-sm font-data-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter">
        ...
        <section className="glass-panel p-md rounded-xl flex flex-col min-h-[500px]">
          <div className="border-b border-outline-variant/10 pb-md mb-md flex justify-between items-center">
          ...
          <div className="space-y-md overflow-y-auto">
            {topThreats.length > 0 ? topThreats.map((threat, idx) => (
              <div key={idx} className="group cursor-pointer bg-surface-container/50 p-sm rounded-lg border border-outline-variant/10 hover:border-primary-container/30 transition-colors">
        ...
        <section className="glass-panel p-md rounded-xl flex flex-col min-h-[500px]">
          ...
          <div className="space-y-md overflow-y-auto">
            {liveAlerts.length > 0 ? liveAlerts.map((alert, idx) => (
              <div key={idx} className="flex gap-md border-l-2 border-primary-container pl-sm">
