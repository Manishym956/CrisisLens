    ...
    <div className="max-w-7xl mx-auto px-margin py-xl space-y-lg">
      ...
      <section className="mb-lg">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-md">
          <div>
            <h1 className="font-h1 text-h1 text-primary glow-cyan mb-xs">Predictive Dashboard</h1>
          ...
          <div className="flex gap-sm">
            <button className="bg-gradient-to-r from-[#00dbe9] to-[#571bc1] hover:shadow-[0_0_20px_rgba(0,219,233,0.4)] hover:-translate-y-0.5 transition-all px-md py-sm rounded-lg text-on-primary font-data-mono text-data-mono flex items-center gap-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        ...
        <div className="lg:col-span-8 glass-panel rounded-xl overflow-hidden relative group">
          <div className="p-md flex items-center justify-between border-b border-outline-variant/10">
          ...
          <div className="relative h-[450px] bg-surface-container-lowest overflow-hidden">
            ...
            <div className="absolute top-1/4 left-1/3 p-sm glass-panel rounded-lg border-error/30 animate-pulse">
            ...
            <div className="absolute bottom-1/3 right-1/4 p-sm glass-panel rounded-lg border-primary/30">
        ...
        <div className="lg:col-span-4 glass-panel rounded-xl p-md flex flex-col justify-between">
          <div>
          ...
          <div className="pt-md border-t border-outline-variant/10 mt-md">
            <p className="font-data-mono text-data-mono text-xs text-on-surface-variant flex items-center gap-xs">
        ...
        <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-gutter">
          ...
          {loading ? (
            ...
            predictions.emerging_threats.map((threat: any, idx: number) => {
              ...
              return (
                <div key={idx} className={`glass-panel rounded-xl p-md relative overflow-hidden ${isCritical ? 'border-error/20 threat-pulse' : 'border-primary/20'}`}>
                  <div className="absolute top-0 right-0 p-sm">
                    <span className={`${isCritical ? 'bg-error text-on-error' : 'bg-primary-container text-on-primary-container'} font-data-mono text-[10px] px-xs py-[2px] rounded uppercase`}>
                      {threat.confidence_level} RISK
                    </span>
                  </div>
                  <div className="flex items-start gap-sm mb-md">
                    <div className={`${isCritical ? 'bg-error-container/20 text-error' : 'bg-primary-container/20 text-primary'} p-xs rounded-lg`}>
                  ...
                  <p className="font-h3 text-h3 mb-sm line-clamp-2">{threat.predicted_narrative}</p>
                  
                  <div className="bg-surface-container-low p-sm rounded-lg mt-auto">
          ...
          {predictions && predictions.election_misinformation_risk && (
            <div className="col-span-3 lg:col-span-12 glass-panel p-md rounded-xl mt-md">
